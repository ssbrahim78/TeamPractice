...
public class Pizza1 {
	...
	public Pizza1 () {  // default constructor
		
	}
	
	public Pizza1(String address) {// constructor with parameters
	...
	public static void main(String[] args) {
		...
		double price=10.50;
		Pizza1 address = new Pizza1("New York");
		Pizza1 promotion = new Pizza1();
